    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center px-0 mx-auto w-full md:flex-col md:items-stretch md:min-h-full md:flex-nowrap">
            ...
            <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden">
                ...
                <!-- Heading -->
                <nav-heading v-if="$page.props.auth.user.level==1">
                    Manajemen Data
                </nav-heading>

                <ul class="flex flex-col list-none md:flex-col md:min-w-full" v-if="$page.props.auth.user.level==1">
